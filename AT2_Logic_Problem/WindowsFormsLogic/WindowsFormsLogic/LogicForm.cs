...
namespace WindowsFormsLogic
{
    public partial class LogicForm : Form
    {
        ...
        // switch the lights in the dining, lounge and enterance on and off
        private void Lounge_Switch_Click(object sender, EventArgs e)
        {
            if (lounge_Light_Status || dining_Light_Status || entrance_Light_Status)
            {
